export const config = {
    ...
    // 公众号APP_ID
    APP_ID: "wxef48f59d5e575bc9",

    // 公众号APP_SECRET
    APP_SECRET: "c5aea559d49418d9c56de0edf5c8100c",

    // 模板消息id
    TEMPLATE_ID: "Y_xjR98kUU6YIB28MsTYK9MFNjgtAjQHokDmhRMGpic",
    ...
    FESTIVALS: [
      ...
      {"type": "生日", "name": "军", "year": "2001", "date": "02-10"} */
    ],
    ...
    SLOT_LIST: [
      // 这样配置的话，就会每次发送这句话
      {"keyword": "encourage_oneself", contents: "加油"},
      // 这样配置的话，就会每次随机选一句话发送
